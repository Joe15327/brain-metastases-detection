...
def SSD_ResNet(image_size,
    ...
    L128 = base_model.get_layer(name = 'activation_1').output    
    L64 =  base_model.get_layer(name = 'activation_10').output
    
    L32 =  base_model.get_layer(name = 'activation_22').output
    L32 =  Conv2D(1024, (3,3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg))(L32)
    ...
    L128_mbox_conf = Conv2D(n_boxes[0] * n_classes, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='L128_mbox_conf')(L128)
    L64_mbox_conf  = Conv2D(n_boxes[1] * n_classes, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='L64_mbox_conf')(L64)
    ...
    L128_mbox_loc = Conv2D(n_boxes[0] * 4, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='L128_mbox_loc')(L128)
    L64_mbox_loc  = Conv2D(n_boxes[1] * 4, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='L64_mbox_loc')(L64)
